...
def logistic(X, y, iteration):
	...
	for it in range(iteration):
		...
		print('Iteration: ' + str(it) + '. Cross entropy: ' + str(cost / len(X)))
	print('\nCategorization Accuracy: ' + str(accuracy(predict, y.flatten())))
	np.save('w_best.npy',w)
	return w
...
np.save('normal_best.npy',normal)
